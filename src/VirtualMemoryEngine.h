...
public:
    // Konstruktor: (veličina_bloka u bajtovima, max_ram_pool u bajtovima, max_blokova_u_memoriji, maksimalna_veličina_VRAM_a)
    // Parametar maxVramSize ograničava adresni prostor (podrazumevano 512 KB = 524288 bajtova)
    VirtualMemoryEngine(size_t blockSize = 32768, size_t ramLimit = 131072, int maxBlocks = 16, uint32_t maxVramSize = 524288);
