...
public:
    // Konstruktor: (veličina_bloka u bajtovima, max_ram_pool u bajtovima, max_blokova_u_memoriji)
    VirtualMemoryEngine(size_t blockSize = 32768, size_t ramLimit = 131072, int maxBlocks = 16);
    ~VirtualMemoryEngine();
